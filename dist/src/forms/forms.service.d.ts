...
export declare class FormsService {
    ...
    getFormById(formId: string): Promise<{
        versions: ({
            sections: ({
                questions: ({
                    options: {
    ...
    getActiveSchema(formId: string): Promise<Prisma.JsonValue>;
    getActiveSchemaBySlug(slug: string): Promise<Prisma.JsonValue>;
    ...
    getQuestionAnalytics(questionId: string): Promise<{
        questionId: string;
        textAnswers: number;
        optionCounts: (Prisma.PickEnumerable<Prisma.QuestionResponseGroupByOutputType, Prisma.QuestionResponseScalarFieldEnum | Prisma.QuestionResponseScalarFieldEnum[]> & {
            _count: true | {
                id?: number | undefined;
