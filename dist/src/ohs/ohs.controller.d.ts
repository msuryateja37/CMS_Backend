...
export declare class OhsController {
    private readonly ohs;
    constructor(ohs: OhsService);
    createRisk(req: Request, body: any): import("@prisma/client").Prisma.Prisma__RiskRegisterClient<{
        id: string;
    ...
    createJsa(req: Request, body: any): import("@prisma/client").Prisma.Prisma__JsaClient<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: string | null;
